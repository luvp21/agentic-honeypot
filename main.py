...
@app.get("/check-idle-sessions")
async def check_idle_sessions(api_key: str = Depends(verify_api_key)):
    """
    BACKGROUND CHECK: Check all sessions for idle timeout and send callbacks if needed.
    ...
    return {
        ...
        "callbacks_sent": callback_sent_count
    }
